...
public class PopupDialog extends Dialog {
     ...
     * @param dim 是否背景变暗
     */
    public PopupDialog(Context context, View contentView, boolean dim) {
        super(context, (dim ? R.style.FullScreenDialog : R.style.FullScreenDialogTrans));
        mContext = context;
     ...
     * @return boolean
     */
    public boolean isVisible (int resId) {
        View v = mRootView.findViewById(resId);
        if (v != null) {
    ...
    private void initView(int layoutId) {
        ...
        mRootView = LayoutInflater.from(mContext)
                .inflate(layoutId, (ViewGroup) mWindow.getDecorView());
    ...
    private void initView(View contentView) {
        ...
        // 获取窗口
        mWindow = getWindow();
        ((ViewGroup) mWindow.getDecorView()).addView(contentView);
        // 设置布局id
